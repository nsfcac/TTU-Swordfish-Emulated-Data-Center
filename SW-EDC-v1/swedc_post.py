...
#This code is for sending post requests.
...
def get_ip_onecontainer(s,i,o,network_name):
    '''
         This function is for getting IP.
...
#part 3: runnig the requested post command.----------------------------------------------------------------------------   	 
#----------------------------------------------------------------------------------------------------------------------
def run_post_command(num,uri,item,network_name):
    '''
         This function is for runnig the requested post command.
